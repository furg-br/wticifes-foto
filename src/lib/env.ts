...
export function getRateLimits() {
  return {
    ...
    globalPerDay: integerEnv("GLOBAL_MAX_PER_DAY", 2000),
    hardDaily: integerEnv("HARD_DAILY_LIMIT", 2000),
    participantPerHour: integerEnv("PARTICIPANT_MAX_PER_HOUR", 5),
    participantPerDay: integerEnv("PARTICIPANT_MAX_PER_DAY", 10),
    participantTotal: integerEnv("PARTICIPANT_MAX_TOTAL", 20),
